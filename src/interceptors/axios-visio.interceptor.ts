...
const apiVisio: AxiosInstance = axios.create({
  baseURL: process.env.NEXT_PUBLIC_GO_WS_URL!+"/api",
  headers: {
...
apiVisio.interceptors.request.use(
  async (config) => {
...
apiVisio.interceptors.response.use(
